...
// import InstrumentTabs from "./InstrumentTabs";
// import Portfolio from "./Portfolio";
// import WatchlistTable from "./WathclistTable";
import { useSelector } from "react-redux";
import { useLocation } from "react-router-dom";
...
const InstrumentTabs = lazy(() => import("./InstrumentTabs"));
const Portfolio = lazy(() => import("./Portfolio"));
const MutualFundPortfolio = lazy(() => import("./MutualFundPortfolio"));
const WatchlistTable = lazy(() => import("./WathclistTable"));
...
//   useEffect(() => {
//     const intervalId = setInterval(fetchInvestmentData, 60000);
//     fetchInvestmentData(); // Initial fetch on component mount
...
//   // Memoize the total investments and balance calculations to prevent unnecessary re-renders
//   const totalInvestment = useMemo(() => {
//     return ((MyInvestMent + MFInvestMent) / 1000).toFixed(2);
//   }, [MyInvestMent, MFInvestMent]);

//   const formattedBalance = useMemo(() => {
//     return (MyBalance / 1000).toFixed(2);
//   }, [MyBalance]);

//   const netWorth = useMemo(() => {
//     return ((MyInvestMent + MFInvestMent + Number(MyBalance)) / 1000).toFixed(
//       2
//     );
//   }, [MyInvestMent, MFInvestMent, MyBalance]);

//   return (
//     <Container>
//       <InstrumentTabs />
//       <small style={{ color: "#2759e5" }}>
//         Note : Details will take some time to load, please wait a few seconds
//       </small>
//       <InvestMentBox>
//         <Title>My Total Investments ₹ {totalInvestment}K</Title>
//         <AssestBox>
//           <Box>
//             <img src="../../Stocks.png" alt="Stocks" />
//             <h3>Stocks</h3>
//             <p>₹ {(MyInvestMent / 1000).toFixed(2)} k</p>
//           </Box>
//           <Box>
//             <img src="../../mutualfund.png" alt="Mutual Funds" />
//             <h3>Mutual Funds</h3>
//             <p>₹ {(MFInvestMent / 1000).toFixed(2)} k</p>
//           </Box>
//         </AssestBox>
//       </InvestMentBox>

//       <InvestMentBox>
//         <Title>My Total Bank Balance ₹ {formattedBalance}K</Title>
//         <AssestBox>
//           <Box>
//             <img src="../../bank.png" alt="Bank" />
//             <h3>Bank Balance</h3>
//             <p>₹ {formattedBalance} k</p>
//           </Box>
//         </AssestBox>
//       </InvestMentBox>
...
const Investment = () => {
  ...
  // Memoize the total investment and net worth calculations
  const totalInvestment = useMemo(
    () => ((MyInvestMent + MFInvestMent) / 1000).toFixed(2),
    [MyInvestMent, MFInvestMent]
  );

  const totalNetWorth = useMemo(
    () => ((MyInvestMent + MFInvestMent + Number(MyBalance)) / 1000).toFixed(2),
    [MyInvestMent, MFInvestMent, MyBalance]
  );
  ...
  return (
    <Container>
      ...
      <small style={{ color: "#2759e5" }}>
        Note : Details will take some time to load please wait for a few seconds
      </small>
